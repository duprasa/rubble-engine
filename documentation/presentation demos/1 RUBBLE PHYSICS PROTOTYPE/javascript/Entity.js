var Entity = Object.subClass({
    init: function(x,y,width,height,color){
        ...
        //CONSTANTS
        this.maxvelocity = Object.create({},{x:{writable:true, value:10},
                                             y:{writable:true, value:10}});
        this.accel =       Object.create({},{x:{writable:true, value:2},
                                             y:{writable:true, value:2}});
...
Entity.prototype.onCollision = function(colEntity,direction){
    ...
    //     return;
    // }
    // //change to random color to visualize hit test
    // var number = (parseInt(this.color,16) + 100) % 16777215;
    // this.color = number.toString(16);
    var newlocation;
    switch(direction){
        case 'x':
